...
classifiers = classifiers=[['DT-None', RandomForestClassifier()], ['DT-SQRT', RandomForestClassifier(max_features='sqrt')], ['DT-log2', RandomForestClassifier(max_features='log2')],
