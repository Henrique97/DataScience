...
classifiers = [['1nn',neighbors.KNeighborsClassifier(n_neighbors=1)],
                ['3nn',neighbors.KNeighborsClassifier(n_neighbors=3)],
                ['5nn',neighbors.KNeighborsClassifier(n_neighbors=5)],
                ['7nn',neighbors.KNeighborsClassifier(n_neighbors=7)],
                ['9nn',neighbors.KNeighborsClassifier(n_neighbors=9)],
                ['25nn',neighbors.KNeighborsClassifier(n_neighbors=25)],
                ['51nn',neighbors.KNeighborsClassifier(n_neighbors=51)],
                ['101nn',neighbors.KNeighborsClassifier(n_neighbors=101)],
                ['151nn',neighbors.KNeighborsClassifier(n_neighbors=151)]]
...
fig, ax = plt.subplots()
ax.plot([1,3,5,7,9,25,51,101,151], accu)
...
fig, ax = plt.subplots()
ax.plot([1,3,5,7,9,25,51,101,151], spec)

ax.set(xlabel='k', ylabel='specificity',
       title='Specificity')
ax.grid()
...
fig, ax = plt.subplots()
ax.plot([1,3,5,7,9,25,51,101,151], sens)

ax.set(xlabel='k', ylabel='sensitivity',
       title='Sensitivity')
ax.grid()
...
classifiers = [['7nn-uniform',neighbors.KNeighborsClassifier(n_neighbors=7, weights='uniform')],
                ['7nn-distance',neighbors.KNeighborsClassifier(n_neighbors=7, weights='distance')]]
