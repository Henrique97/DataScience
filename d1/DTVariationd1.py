...
values = np.concatenate((values, (np.logspace(1,9,dtype='int'))[0:24]))
...
values = np.array([1,3,5,7,9])
values = np.concatenate((values, (np.logspace(1,9,dtype='int'))[0:10]))
...
values = np.array([1,3,5,7,9])
values = np.concatenate((values, (np.logspace(1,9,dtype='int'))[0:15]))
